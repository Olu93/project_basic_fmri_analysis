...
matlabbatch{crr_len}.cfg_basicio.var_ops.cfg_named_input.input = '<UNDEFINED>';
% matlabbatch{crr_len}.cfg_basicio.var_ops.cfg_named_input.input = 'con_0001';
...
matlabbatch{crr_len}.cfg_basicio.run_ops.call_matlab.inputs{2}.string(1) = cfg_dep('Named Input: file_seperator', substruct('.','val', '{}',{sep_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
matlabbatch{crr_len}.cfg_basicio.run_ops.call_matlab.inputs{3}.string = [c_type '_masked'];
...
matlabbatch{crr_len}.spm.stats.factorial_design.masking.em = {'C:\Users\ohund\Documents\MATLAB\masks\brodmann_sensori_motor_mask.nii,1'};
