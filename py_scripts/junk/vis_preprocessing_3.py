...
cut_coords = None
display_list = [fimg["image"] for _, fimg in ordered_dict.items()]

plotting.plot_img_comparison(display_list[0], display_list[1])
display.savefig(target_path / "prep" / f"preprocessing_comp.png")
