%-----------------------------------------------------------------------
% Job saved on 15-May-2021 02:47:18 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7487)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.var_ops.cfg_named_input.name = 'contrast_folder';
matlabbatch{1}.cfg_basicio.var_ops.cfg_named_input.input = 'rh_bothhrf_vs_rest_bothhrf';
...
matlabbatch{3}.cfg_basicio.var_ops.cfg_named_input.input = 'con_0051';
