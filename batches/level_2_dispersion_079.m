%-----------------------------------------------------------------------
% Job saved on 15-May-2021 02:47:43 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7487)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.var_ops.cfg_named_input.name = 'contrast_folder';
matlabbatch{1}.cfg_basicio.var_ops.cfg_named_input.input = 'tongue_vs_both';
...
matlabbatch{3}.cfg_basicio.var_ops.cfg_named_input.input = 'con_0079';
