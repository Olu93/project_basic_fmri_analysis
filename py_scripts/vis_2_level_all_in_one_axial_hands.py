...
hands_statistical_images = image.load_img(list(sub_file_path.rglob('./hands_vs_rest/spm*_0001.nii'))[0].as_posix())
...
dataset = OrderedDict(
    ...
    hands=dataset["hands"],
    hands_vs_rest=dataset["hands" + _suffix],
    lh_vs_rh=dataset["lh_vs_rh"],
    rh_vs_lh=dataset["rh_vs_lh"],
)
...
#     y=.5,
# )
display.savefig(target_path / "misc" / "level_2_results_allinone_axial_hands.png")
