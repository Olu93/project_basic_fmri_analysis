%-----------------------------------------------------------------------
% Job saved on 15-May-2021 13:07:06 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7487)
...
matlabbatch{19}.spm.util.checkreg.data(1) = cfg_dep('Access part of MATLAB variable: val.svar.feet(1)', substruct('.','val', '{}',{17}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','output'));
matlabbatch{19}.spm.util.checkreg.data(2) = cfg_dep('Access part of MATLAB variable: val(1)', substruct('.','val', '{}',{18}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','output'));
