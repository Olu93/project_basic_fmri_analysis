%-----------------------------------------------------------------------
% Job saved on 27-Apr-2021 03:31:38 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7487)
...
matlabbatch{1}.spm.stats.fmri_spec.sess(4).cond.duration = [43
                                                             ...
                                                             41
                                                             29];
matlabbatch{1}.spm.stats.fmri_spec.sess(4).cond.tmod = 0;
...
matlabbatch{1}.spm.stats.fmri_spec.sess(5).cond.tmod = 0;
