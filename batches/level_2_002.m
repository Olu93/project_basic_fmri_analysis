%-----------------------------------------------------------------------
% Job saved on 25-Apr-2021 17:22:05 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7487)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.var_ops.cfg_named_input.name = 'name';
matlabbatch{1}.cfg_basicio.var_ops.cfg_named_input.input = 'lh';
matlabbatch{2}.cfg_basicio.var_ops.cfg_named_input.name = 'pattern';
matlabbatch{2}.cfg_basicio.var_ops.cfg_named_input.input = 'con_0002';
