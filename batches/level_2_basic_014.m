%-----------------------------------------------------------------------
% Job saved on 07-May-2021 05:47:17 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7487)
...
matlabbatch{7}.cfg_basicio.run_ops.call_matlab.inputs{3}.string = 'basic';
...
matlabbatch{8}.cfg_basicio.run_ops.call_matlab.inputs{3}.string = 'basic';
