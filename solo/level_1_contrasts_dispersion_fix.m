...
matlabbatch{crr_len}.cfg_basicio.var_ops.cfg_named_input.name = 'Feet vs Both-Derivatives';
matlabbatch{crr_len}.cfg_basicio.var_ops.cfg_named_input.input = [ 2 -1 -1  mv_gr  0  0  0  mv_gr  0  0  0  mv_gr  0  0  0  mv_gr condition_biases 0];
crr_len = length(matlabbatch)+ 1;
matlabbatch{crr_len}.cfg_basicio.var_ops.cfg_named_input.name = 'LH vs Both-Derivatives';
matlabbatch{crr_len}.cfg_basicio.var_ops.cfg_named_input.input = [ 0  0  0  mv_gr  2 -1 -1  mv_gr  0  0  0  mv_gr  0  0  0  mv_gr condition_biases 0];
crr_len = length(matlabbatch)+ 1;
matlabbatch{crr_len}.cfg_basicio.var_ops.cfg_named_input.name = 'RH vs Both-Derivatives';
matlabbatch{crr_len}.cfg_basicio.var_ops.cfg_named_input.input = [ 0  0  0  mv_gr  0  0  0  mv_gr  2 -1 -1  mv_gr  0  0  0  mv_gr condition_biases 0];
crr_len = length(matlabbatch)+ 1;
matlabbatch{crr_len}.cfg_basicio.var_ops.cfg_named_input.name = 'Tongue vs Both-Derivatives';
matlabbatch{crr_len}.cfg_basicio.var_ops.cfg_named_input.input = [ 0  0  0  mv_gr  0  0  0  mv_gr  0  0  0  mv_gr  2 -1 -1  mv_gr condition_biases 0];
crr_len = length(matlabbatch)+ 1;
