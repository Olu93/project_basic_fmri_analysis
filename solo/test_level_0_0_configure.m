...
matlabbatch{current_length}.cfg_basicio.var_ops.cfg_named_input.input = 'sub01';

current_length = length(matlabbatch) +1;
results_folder_name = current_length;
matlabbatch{current_length}.cfg_basicio.var_ops.cfg_named_input.name = 'results_folder';
matlabbatch{current_length}.cfg_basicio.var_ops.cfg_named_input.input = results_folder;
...
matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{1}.string(1) = cfg_dep('Named Input: root', substruct('.','val', '{}',{root_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
...
current_length = length(matlabbatch) +1;
subject_folder_results_num = current_length;
matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{1}.string(1) = cfg_dep('Named Input: root', substruct('.','val', '{}',{root_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{2}.string(1) = cfg_dep('Named Input: file_seperator', substruct('.','val', '{}',{sep_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{3}.string(1) = cfg_dep('Named Input: subject', substruct('.','val', '{}',{subject_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{4}.string(1) = cfg_dep('Named Input: file_seperator', substruct('.','val', '{}',{sep_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{5}.string = 'results';
matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.outputs{1}.filter.dir = true;
matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.fun = 'append';
...
for regnum = 1:length(regex_filters)
    ...
    for fnum = 1:length(folders) 
        ...
        current_length = length(matlabbatch) +1;
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{1}.string(1) = cfg_dep('Named Input: root', substruct('.','val', '{}',{1}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{2}.string(1) = cfg_dep('Named Input: file_seperator', substruct('.','val', '{}',{sep_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{3}.string(1) = cfg_dep('Named Input: subject', substruct('.','val', '{}',{subject_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
        ...
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{7}.string(1) = cfg_dep(['Named Input: ' curr_condition], substruct('.','val', '{}',{folder_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{8}.string(1) = cfg_dep('Named Input: seperator', substruct('.','val', '{}',{sep_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{9}.string = 'rp_';
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{10}.string(1) = cfg_dep('Named Input: subject', substruct('.','val', '{}',{subject_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{11}.string = '_';
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{12}.string(1) = cfg_dep(['Named Input: ' curr_condition], substruct('.','val', '{}',{folder_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.inputs{13}.string = '-0001.txt';
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.outputs{1}.filter.dir = true;
        matlabbatch{current_length}.cfg_basicio.run_ops.call_matlab.fun = 'append';
    ...
    ftrans_num = initial_folder_num + 4;
    offset = 5;
    for fnum = 1:length(folders) 
        curr_condition = folders{fnum};
        ...
        matlabbatch{current_length}.cfg_basicio.var_ops.cfg_save_vars.vars(var_num).vname = ['rp_' curr_condition];
        matlabbatch{current_length}.cfg_basicio.var_ops.cfg_save_vars.vars(var_num).vcont(1) = cfg_dep(['File: Translation (' num2str(ftrans_num) ')'], substruct('.','val', '{}',{ftrans_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','outputs', '{}',{1}));

        var_num = var_num + 1;
        fset_num = fset_num + offset;
        fmean_num = fmean_num + offset;
        ftrans_num = ftrans_num + offset;
    end
    ...
    var_num = var_num +1;
    matlabbatch{current_length}.cfg_basicio.var_ops.cfg_save_vars.vars(var_num).vname = 'seperator';
    matlabbatch{current_length}.cfg_basicio.var_ops.cfg_save_vars.vars(var_num).vcont(1) = seperator;

    var_num = var_num +1;
    matlabbatch{current_length}.cfg_basicio.var_ops.cfg_save_vars.vars(var_num).vname = 'results_folder';
    matlabbatch{current_length}.cfg_basicio.var_ops.cfg_save_vars.vars(var_num).vcont(1) = cfg_dep(['Results Dir (' num2str(subject_folder_results_num) ')'], substruct('.','val', '{}',{subject_folder_results_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','outputs', '{}',{1}));

    var_num = var_num +1;
    matlabbatch{current_length}.cfg_basicio.var_ops.cfg_save_vars.vars(var_num).vname = 'curr_subject';
    matlabbatch{current_length}.cfg_basicio.var_ops.cfg_save_vars.vars(var_num).vcont = cfg_dep(['Current Subject (' num2str(subject_num) ')'], substruct('.','val', '{}',{subject_num}, '.','val', '{}',{1}, '.','val', '{}',{1}), substruct('.','input'));
