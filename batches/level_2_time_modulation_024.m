%-----------------------------------------------------------------------
% Job saved on 07-May-2021 05:54:01 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7487)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.var_ops.cfg_named_input.name = 'contrast_folder';
matlabbatch{1}.cfg_basicio.var_ops.cfg_named_input.input = 'tongue_time_vs_rest_time';
...
matlabbatch{3}.cfg_basicio.var_ops.cfg_named_input.input = 'con_0024';
...
matlabbatch{7}.cfg_basicio.run_ops.call_matlab.inputs{3}.string = 'time_modulation';
...
matlabbatch{8}.cfg_basicio.run_ops.call_matlab.inputs{3}.string = 'time_modulation';
