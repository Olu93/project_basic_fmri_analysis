%-----------------------------------------------------------------------
% Job saved on 07-May-2021 05:53:58 by cfg_util (rev $Rev: 7345 $)
% spm SPM - SPM12 (7487)
% cfg_basicio BasicIO - Unknown
%-----------------------------------------------------------------------
matlabbatch{1}.cfg_basicio.var_ops.cfg_named_input.name = 'contrast_folder';
matlabbatch{1}.cfg_basicio.var_ops.cfg_named_input.input = 'movements_vs_time';
...
matlabbatch{3}.cfg_basicio.var_ops.cfg_named_input.input = 'con_0020';
